...
router.post("/", authMiddleware.authenticate, roleMiddleware("admin"), tagController.createTag);
router.patch("/:id", authMiddleware.authenticate, roleMiddleware("admin"), tagController.updateTag);
router.delete("/:id", authMiddleware.authenticate, roleMiddleware("admin"), tagController.deleteTag);
